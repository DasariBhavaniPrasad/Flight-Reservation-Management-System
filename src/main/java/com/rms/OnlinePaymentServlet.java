...
public class OnlinePaymentServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Retrieve booking and seat details from session
        ...
        if (booking != null) {
            try {
                ...
                // Update booking status to 'Confirmed' after online payment
        ...
        // Redirect to manageBookings.jsp after displaying invoice
